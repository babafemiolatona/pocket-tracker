...
from .views import (CreateExpenseView, ExpenseListView,
...
urlpatterns = [
    ...
    path('expense/<int:pk>/update', ExpenseUpdateView.as_view(),
         name='expense-edit'),
    path('expense/<int:pk>/delete', ExpenseDeleteView.as_view(),
         name='expense-delete'),
